    ...
    if (typeof window !== 'undefined' && window.TradingView) {
      ...
      new window.TradingView.widget({
        ...
        enabled_features: ["save_chart_properties_to_local_storage","use_localstorage_for_settings","display_legend_on_all_charts","show_exchange_logos","items_favoriting","pricescale_currency","show_dom_first_time","show_right_widgets_panel_by_default",
                            "show_symbol_logos","show_zoom_and_move_buttons_on_touch","snapshot_trading_drawings","show_percent_option_for_right_margin","pricescale_unit","fix_left_edge",
                            "use_na_string_for_not_available_values","confirm_overwrite_if_chart_layout_with_name_exists","symbol_info_price_source",
                            "end_of_period_timescale_marks","create_volume_indicator_by_default_once","header_in_fullscreen_mode",
                            ...
                            "move_logo_to_main_pane","countdown","header_layouttoggle","chart_template_storage","study_templates"],
        disabled_features: ["hide_main_series_symbol_from_indicator_legend","display_market_status","header_saveload","custom_resolutions","tick_resolution"]
